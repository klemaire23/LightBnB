...
INSERT INTO users (name, email, password) VALUES ('Morrigan Stanley', 'themorrigan@gmail.com', '$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'), 
('Eva Mendoza', 'mendozee@outlook.ca', '$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u'), ('Robin Hart', 'hartthrob99@hotmail.com', '$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u');
...
INSERT INTO reservations (start_date, end_date, property_id, guest_id) VALUES ('2018-09-11', '2018-09-26', 2, 3), ('2019-01-04', '2019-02-01', 2, 3),
('2023-10-01', '2023-10-14', 1, 3);

-- data for property_reviews table
INSERT INTO property_reviews (guest_id, property_id, reservation_id, rating, message) VALUES (3, 2, 1, 3, 'messages'), (2, 2, 2, 4, 'messages'),
(3, 1, 3, 4, 'messages');